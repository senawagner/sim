...
class EquipamentoController extends Controller
{
    public function index()
    {
        ...
        return view('coordenador.equipamentos.index', compact('equipamentos'));
    }

    public function create()
    {
        $filiais = Filial::all();
        return view('coordenador.equipamentos.create', compact('filiais'));
    }
    ...
    {
        $filiais = Filial::all();
        return view('coordenador.equipamentos.edit', compact('equipamento', 'filiais'));
    }
    ...
    public function update(Request $request, Equipamento $equipamento)
    {
        ...
        return redirect()->route('coordenador.equipamentos.index')
