...
class ManutencaoController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.manutencoes.create', compact('filiais', 'equipamentos'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('admin.manutencoes.index')->with('success', 'Manutenção registrada com sucesso!');
        } catch (\Exception $e) {
            Log::error('Erro ao registrar manutenção', ['error' => $e->getMessage()]);
            return redirect()->route('admin.manutencoes.create')->with('error', 'Erro ao registrar manutenção. Por favor, tente novamente.');
        }
    }

    public function show(Manutencao $manutencao)
    {
        return view('admin.manutencoes.show', compact('manutencao'));
    }
    ...
    public function edit(Manutencao $manutencao)
    {
        $filiais = Filial::all();
        $equipamentos = Equipamento::all();
        return view('admin.manutencoes.edit', compact('manutencao', 'filiais', 'equipamentos'));
    }
    ...
    public function update(Request $request, Manutencao $manutencao)
    {
        ...
        try {
            ...
            return redirect()->route('admin.manutencoes.edit', $manutencao)->with('error', 'Erro ao atualizar manutenção. Por favor, tente novamente.');
        }
    }
    ...
    public function destroy(Manutencao $manutencao)
    {
        try {
            ...
            return redirect()->route('admin.manutencoes.index')->with('error', 'Erro ao excluir manutenção. Por favor, tente novamente.');
        }
    }
