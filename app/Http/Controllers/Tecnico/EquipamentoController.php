...
class EquipamentoController extends Controller
{
    public function index()
    {
        ...
        return view('tecnico.equipamentos.index', compact('equipamentos'));
    }

    public function create()
    {
        $filiais = Filial::all();
        return view('tecnico.equipamentos.create', compact('filiais'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('tecnico.equipamentos.index')
    ...
    {
        $filiais = Filial::all();
        return view('tecnico.equipamentos.edit', compact('equipamento', 'filiais'));
    }
