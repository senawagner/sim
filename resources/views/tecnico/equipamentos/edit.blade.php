...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('tecnico.equipamentos.update', $equipamento->equipamento_id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="d-flex justify-content-end">
                    <a href="{{ route('arquiteto.equipamentos.index') }}" class="btn btn-secondary me-2">Cancelar</a>
