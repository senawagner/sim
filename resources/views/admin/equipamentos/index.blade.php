...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2>Equipamentos</h2>
        <a href="{{ route('admin.equipamentos.create') }}" class="btn btn-primary">
                    ...
                    <tbody>
                        @forelse($equipamentos as $equipamento)
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('admin.equipamentos.edit', $equipamento->equipamento_id) }}" 
                                           class="btn btn-sm btn-primary">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <form action="{{ route('admin.equipamentos.destroy', $equipamento->equipamento_id) }}" 
                                              method="POST" 
                                              class="d-inline">
                                            @csrf
                                            @method('DELETE')
