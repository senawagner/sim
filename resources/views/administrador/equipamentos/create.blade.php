...
<div class="container-fluid">
    <div class="d-flex align-items-center mb-4">
        <a href="{{ route('administrador.equipamentos.index') }}" class="btn btn-link">
            <i class="fas fa-arrow-left"></i> Voltar
        </a>
        <h2 class="mb-0 ms-3">Novo Equipamento</h2>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('administrador.equipamentos.store') }}" method="POST">
                @csrf
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <label for="numero_patrimonio" class="form-label">Número do Patrim��nio</label>
                ...
                <div class="d-flex justify-content-end gap-2">
                    <a href="{{ route('administrador.equipamentos.index') }}" class="btn btn-secondary">Cancelar</a>
